...
const credits = lines.shift().split(' ').map(v => parseInt(v));
let result = false;

if(credits[0] - credits[1] === 0
    || credits[0] - credits[2] === 0
    || credits[1] - credits[2] === 0
    || credits[0] - credits[1] - credits[2] === 0
    || credits[0] - credits[1] + credits[2] === 0
    || credits[0] + credits[1] - credits[2] === 0) result = true;
